...
* [`src/cljs_2048/styles.cljs`](src/cljs_2048/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs_2048/`](src/cljs_2048/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs_2048/core.cljs): contains the SPA entry point, `init`
* [`test/cljs_2048/`](test/cljs_2048/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `cljs-2048` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cljs_2048/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns cljs-2048.example
  (:require [cljs-2048.config :as config])
